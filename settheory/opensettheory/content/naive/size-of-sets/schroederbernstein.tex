...
\begin{document}
	...
	\olfileid{sfr}{siz}{sb}
	\olsection{The notion of size, and Schr\"oder--Bernstein}\ollabel{sb}
\begin{explain}
...
\end{explain}
\begin{thm}[Schr\"oder--Bernstein]\ollabel{schroderbernstein}
...
This result, however, is really rather \emph{difficult} to prove. Indeed, although Cantor stated the result, others proved it.\footnote{For more on the history, see e.g.\ \citet[165--6]{Potter2004}.} And for our part, we will only be in a position to \emph{prove} Schr\"oder--Bernstein in \olref[sfr][cardinals][card-sb]{card-sb}. But for now, you can (and must) take it on trust. 
