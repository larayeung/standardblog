...
\olsection{Appendix: ordered rings and fields}\ollabel{checking}
...
But here is a small loose end to tidy up. In \olref[sfr][arith][cut]{cut}, I suggest that we can take $\sqrt{2} = \Setabs{p \in \Rat}{p < 0 \text{ or }p^2 < 2}$. But we do need to show that this set is a \emph{cut}. Here is a proof of that fact:
\begin{proof}
