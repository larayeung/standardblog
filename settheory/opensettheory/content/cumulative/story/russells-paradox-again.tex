...
\begin{document}
		\olfileid{sfr}{story}{rus}
	\olsection{Russell's Paradox (again)}\ollabel{rus}
...
\
\\Tempting as this principle is, it is provably inconsistent. We saw this in \olref[sfr][set][rus]{rus}, but the result is so important, and so straightforward, that it's worth repeating. Verbatim.
