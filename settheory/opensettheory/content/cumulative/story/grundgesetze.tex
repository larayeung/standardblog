...
\begin{lem}[working in \emph{Grundgesetze}.] $\forall F \exists s \forall a (a \in s \liff Fa)$
\end{lem}
\begin{proof}
	Fix $F$; now \olref{lem:Fregeextensions} yields $\forall a (a \in \fregeext{F} \liff Fa)$; so $\exists s\forall a(a \in s \liff Fa)$ by existential generalisation. The result follows since $F$ was arbitrary. 
\end{proof}\noindent
