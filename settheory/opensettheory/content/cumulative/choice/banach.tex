...
\begin{document}
		\olfileid{sfr}{choice}{banach}
\olsection{The Banach--Tarski Paradox}\ollabel{banach}
We might also attempt to justify Choice, as Boolos attempted to justify Replacement, by appealing to \emph{extrinsic} considerations (see \olref[sfr][replacement][extrinsic]{extrinsic}). After all, adopting Choice has many desirable consequences: the ability to compare every cardinal; the ability to well-order every set; the ability to treat cardinals as a particular kind of ordinal; etc. 
...
\begin{enumerate}
	...
	\\See \olref[sfr][history][pathology]{pathology} and \olref[sfr][cardinals][cantorplane]{cantorplane}.
	\item There are space-filling curves. 
	\\See \olref[sfr][history][pathology]{pathology} and \olref[sfr][history][hilbertcurve]{hilbertcurve}.
\end{enumerate}
