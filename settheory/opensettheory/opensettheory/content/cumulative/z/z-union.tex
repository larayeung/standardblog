...
\begin{document}
	\olfileid{sfr}{z}{union}
	\olsection{Union}
\olref[sfr][z][sep]{prop:intersectionsexist} gave us intersections. But if we want arbitrary unions to exist, we need to lay down another axiom:
