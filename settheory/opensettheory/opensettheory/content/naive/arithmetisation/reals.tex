...
% Section: Appendix: Real Completeness
%
...
\olsection{The real line}\ollabel{realline}
...
The reals behave very much like the rationals. (Technically, both are examples of \emph{ordered fields}; for the definition of this, see \olref[sfr][arith][check]{orderedfield}.) Now, if you worked through the exercises to chapter \ref{ch:Size}, you will know that there are strictly more reals than rationals, i.e.\ that $\cardless{\Rat}{\Real}$. This was first proved by Cantor. But it's been known for about two and a half millennia that there are irrational numbers, i.e.\ reals which are not rational. Indeed:%\footnote{Now: ``$\sqrt{2}$'' equally refers to both the positive and the negative roots; but in the next few pages, I'll forget about this, and consider only the positive root.}
\begin{thm}\ollabel{root2irrational}
	...
	\end{proof}
\end{thm}\noindent
In passing, this diagrammatic proof allows us to revisit the material from \olref[sfr][history][mythology]{mythology}. Tennenbaum (1927--2006) was a thoroughly modern mathematician; but the proof is undeniably lovely, completely rigorous, and appeals to geometric intuition!
